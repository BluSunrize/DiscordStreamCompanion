...
{
	private final ModuleVoiceChannel module;
	private final VoiceChannel channel;
	private final int updateFrequency;
	public boolean active = true;

	public VoiceHandler(final ModuleVoiceChannel module, final VoiceChannel channel, int updateFrequency)
	{
		this.module = module;
	...
	public void run()
	{
		while(active)
		{
			...
			{
				last = state;
				module.writeVoiceChannel(this.channel, state.split("\n"));
			}
